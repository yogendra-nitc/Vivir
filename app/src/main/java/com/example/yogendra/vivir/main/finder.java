    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        changePassword.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v){
                Intent in = new  Intent(getActivity() , com.example.yogendra.vivir.user.changePassword.class);
                startActivity(in);
            }
        });
        ...
        complainList.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View v){
                Intent in = new  Intent(getActivity() , com.example.yogendra.vivir.user.complainList.class);
                startActivity(in);
            }
        });
        ...
        notification.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View v){
                Intent in = new  Intent(getActivity() , com.example.yogendra.vivir.user.notification.class);
                startActivity(in);
            }
        });
        ...
        setProfile.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View v){
                Intent in = new  Intent(getActivity() , com.example.yogendra.vivir.user.setProfile.class);
                startActivity(in);
            }
        });
        // Left-side Button-8
        ...
        updateFlatRecord.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View v){
                Intent in = new  Intent(getActivity() , com.example.yogendra.vivir.owner.updateFlatRecord.class);
                startActivity(in);
            }
        });
        ...
        uploadFlatDetails.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View v){
                Intent in = new  Intent(getActivity() , com.example.yogendra.vivir.owner.uploadFlatDetails.class);
                startActivity(in);
            }
        });
        ...
        writeComplain.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View v){
                Intent in = new  Intent(getActivity() , com.example.yogendra.vivir.user.writeComplain.class);
                startActivity(in);
            }
        });
        return view;
