...
/**
 * Created by yogendra on 23/4/18.
 */

public class SearchAdapter  extends
        RecyclerView.Adapter<SearchAdapter.Holderview>{

    private List<SearchItem> flatList;
    private Context context;

    public SearchAdapter(List<SearchItem> flatList, Context context) {
    ...
    public void onBindViewHolder(Holderview holder, final int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Toast.makeText(context,"Join us for more details...",Toast.LENGTH_LONG).show();
            }
        });
    }
